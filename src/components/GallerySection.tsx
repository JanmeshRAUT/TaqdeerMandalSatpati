  ...
  return (
    <div className="w-full max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-12">
      ...
      <div className="flex items-center justify-start md:justify-center gap-2 overflow-x-auto pb-2 scrollbar-none">
        {categories.map((cat) => (
          <button
            ...
            className={`px-4 py-2 rounded-xl text-xs sm:text-sm font-bold transition-all shrink-0 font-marathi ${
      ...
      {filteredItems.length === 0 ? (
        <div className="text-center py-16 text-gray-500 font-marathi">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
          {filteredItems.map((item, idx) => (
            <div
              ...
              className="group relative rounded-2xl overflow-hidden bg-[#FAF8F5] border border-gray-200 shadow-2xs cursor-pointer transition-all hover:shadow-lg hover:-translate-y-1"
            >
              ...
              <div className="p-4 bg-white border-t border-gray-100">
                <h3 className="text-sm font-bold text-gray-900 font-marathi truncate">
      ...
      {lightboxIndex !== null && filteredItems[lightboxIndex] && (
        <div className="fixed inset-0 z-50 bg-black/95 backdrop-blur-lg flex items-center justify-center p-4 sm:p-8 animate-in fade-in duration-200">
