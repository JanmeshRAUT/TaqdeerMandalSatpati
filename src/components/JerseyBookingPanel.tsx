...
export const JerseyBookingPanel: React.FC = () => {
  ...
  const sizes = Array.from({ length: 21 }, (_, i) => 10 + i * 2); // 10, 12, 14... 50
  ...
  return (
    <div className="bg-[#FAF8F5] border border-[#FF9933]/30 rounded-3xl p-6 sm:p-10 shadow-sm max-w-4xl mx-auto my-12 font-marathi relative overflow-hidden">
      {/* Decorative Elements */}
      ...
      <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        ...
        <div className="space-y-6 text-center md:text-left">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white border border-[#FF9933]/30 text-xs font-bold text-[#FF9933] shadow-2xs mx-auto md:mx-0">
          ...
          <div className="space-y-2">
            <h2 className="text-3xl sm:text-4xl font-extrabold text-[#111111] tracking-tight">
              {t('मंडळाची अधिकृत जर्सी बुक करा', 'Book Mandal Jersey')}
            </h2>
            ...
            {isSuccess ? (
              ...
              >
                ...
                <p className="text-gray-600 text-sm">
                  {t('तुमची जर्सी यशस्वीरित्या बुक झाली आहे. लवकरच संपर्क करू.', 'Your jersey has been booked. We will contact you soon.')}
                </p>
                <button
                  onClick={() => {
                    setIsSuccess(false);
              ...
              >
                ...
                <p className="text-[10px] text-gray-400 text-center mt-4 font-medium">
                  {t('* बुकिंग केल्यानंतर मंडळाचे प्रतिनिधी संपर्क साधतील.', '* Mandal representative will contact you after booking.')}
                </p>
              </motion.form>
            )}
          </AnimatePresence>
